...
Public Class PRINT_EXAM_REPORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Student_Management_System.PRINT_EXAM_REPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPRINT_EXAM_REPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PRINT_EXAM_REPORT = New PRINT_EXAM_REPORT
        rpt.Site = Me.Site
        Return rpt
    End Function
