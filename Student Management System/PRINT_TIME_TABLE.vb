...
Public Class PRINT_TIME_TABLE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Student_Management_System.PRINT_TIME_TABLE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPRINT_TIME_TABLE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PRINT_TIME_TABLE = New PRINT_TIME_TABLE
        rpt.Site = Me.Site
        Return rpt
    End Function
